-- ============================================================
-- TPI Pokémon TCG - Esquema de Base de Datos
-- PostgreSQL
-- Generado a partir de las entidades JPA
-- ============================================================
...
-- Players (perfiles de juego, 1:1 con users)
...
-- Player stats (estadísticas de ranking)
...
-- Cards (catálogo de cartas sincronizado desde pokemontcg.io)
CREATE TABLE cards (
...
-- Card attacks (ataques de cada carta)
...
-- Card weaknesses (debilidades de cada carta)
...
-- Card resistances (resistencias de cada carta)
...
-- Deck cards (cartas que componen cada mazo)
...
-- Match players (jugadores de cada partida)
...
-- Match states (estados serializados de cada partida)
...
CREATE INDEX idx_cards_pokemon_stage ON cards(pokemon_stage);
CREATE INDEX idx_decks_owner ON decks(owner_player_id);
CREATE INDEX idx_deck_cards_deck ON deck_cards(deck_id);
CREATE INDEX idx_card_attacks_card ON card_attacks(card_id);
CREATE INDEX idx_card_weaknesses_card ON card_weaknesses(card_id);
CREATE INDEX idx_card_resistances_card ON card_resistances(card_id);
CREATE INDEX idx_matches_status ON matches(status);
CREATE INDEX idx_match_players_match ON match_players(match_id);
CREATE INDEX idx_match_states_match ON match_states(match_id);
